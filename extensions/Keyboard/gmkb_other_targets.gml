...
gmkb_show_keyboard_ext(GMKB_TYPE_DEFAULT, GMKB_RK_TYPE_DEFAULT, GMKB_APPEARANCE_LIGHT, GMKB_CAPITALIZE_SENTENCES, false, true);


#define gmkb_show_keyboard_type
gmkb_show_keyboard_ext(argument[0], argument[1], GMKB_APPEARANCE_LIGHT, GMKB_CAPITALIZE_SENTENCES, false, true);
...
#define gmkb_language_disable



#define gmkb_language_enable
